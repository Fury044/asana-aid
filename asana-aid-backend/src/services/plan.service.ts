...
const MOCK_ASANA_LIBRARY: Record<string, any[]> = {
  ...
  'navel issues': [
    ...
    { id: 205, name: 'Ustrasana (Camel Pose)', base_duration: 45, focus_area: 'Navel', media_url: 'https://media.post.rvohealth.io/wp-content/uploads/sites/2/2020/07/Cobra-Pose.gif', instructions: ['Kneel and arch back to touch heels with hands.', 'Support lower back with hands if reaching heels is far.', 'Focus on chest opening.'] }
  ],
  'stress': [
    { id: 301, name: 'Shavasana (Corpse Pose)', base_duration: 300, focus_area: 'Stress', media_url: 'https://cdn.yogajournal.com/wp-content/uploads/2022/10/Savasana_Andrew-McGonigle.gif?width=3840&auto=webp&quality=75&fit=cover', instructions: ['Lie flat on back and relax every muscle.', 'Close eyes and focus on the natural rhythm of breath.', 'Stay as still as possible.'] },
    { id: 302, name: 'Anulom Vilom Breathing', base_duration: 180, focus_area: 'Stress', media_url: 'https://media.post.rvohealth.io/wp-content/uploads/sites/2/2020/06/400x400-Tree_Pose.gif', instructions: ['Alternate nostril breathing for mental calm.', 'Inhale for 4 counts, exhale for 6 counts.', 'Keep spine erect.'] },
    { id: 303, name: 'Legs Up Wall', base_duration: 300, focus_area: 'Stress', media_url: 'https://media.post.rvohealth.io/wp-content/uploads/2020/11/Legs-Up-the-Wall-Pose.gif', instructions: ['Rest legs vertically against a wall while lying on back.', 'Place a pillow under hips if more comfort is needed.', 'Great for circulation.'] },
    { id: 304, name: 'Balasana (Child\'s Pose)', base_duration: 120, focus_area: 'Stress', media_url: 'https://media.post.rvohealth.io/wp-content/uploads/sites/2/2020/07/childs-pose.gif', instructions: ['Gentle forward rest position.', 'Rest your forehead on your hands if mat is too low.', 'Feel your breath in your back.'] }
  ],
  'posture': [
  ...
  'flexibility': [
    ...
    { id: 502, name: 'Triangle Pose', base_duration: 60, focus_area: 'Flexibility', media_url: 'https://post.healthline.com/wp-content/uploads/2017/10/Extended-Triangle.gif', instructions: ['Side stretch with hand reaching for ankle.', 'Keep both legs straight but not locked.', 'Open your chest towards the sky.'] },
    { id: 503, name: 'Pigeon Pose', base_duration: 120, focus_area: 'Flexibility', media_url: 'https://static.wixstatic.com/media/13e392_bd824f1f74ac4927b6a01b22af477a89~mv2.gif', instructions: ['Deep hip opening stretch.', 'Use a block or pillow under the hip of the front leg.', 'Breathe into the sensation.'] },
    { id: 504, name: 'Butterfly Pose', base_duration: 90, focus_area: 'Flexibility', media_url: 'https://ghost-cms.s3.ap-south-1.amazonaws.com/2021/07/Butterfly-pose--bandhakonasana-.gif', instructions: ['Sit and press soles of feet together.', 'Flap "wings" gently or sit in stillness.', 'Keep spine upright.'] }
  ],
  'mood': [
    { id: 601, name: 'Sun Salutation A', base_duration: 180, focus_area: 'Mood', media_url: 'https://2ndstartotherightyoga.wordpress.com/wp-content/uploads/2011/01/sun_salutation_a.gif', instructions: ['Flowing sequence of 12 linked poses.', 'Move with one breath, one movement.', 'Warm up the whole body and mind.'] },
    { id: 602, name: 'Dancer Pose', base_duration: 60, focus_area: 'Mood', media_url: 'https://pictures.picasion.com/pic55/c391fefeb6a1ce2dceb26ff86555177a.gif', instructions: ['Stand and reach back to lift one foot high.', 'Find focus at one point in front of you.', 'Use a wall for support.'] },
    { id: 603, name: 'Warrior I', base_duration: 60, focus_area: 'Mood', media_url: 'https://cdn.jefit.com/assets/img/exercises/gifs/541.gif', instructions: ['Confident lunge with arms raised high.', 'Keep back heel grounded at 45 degrees.', 'Focus your gaze upward.'] },
    { id: 604, name: 'Upward Dog', base_duration: 60, focus_area: 'Mood', media_url: 'https://64.media.tumblr.com/3daf3260ef2d77a497d024d6f575583a/tumblr_o8pq9eiWLy1rysr6eo1_400.gif', instructions: ['Lift chest and legs off floor, weight on hands/feet tops.', 'Press floor away to lift out of shoulders.', 'Gaze gently forward.'] }
  ]
};
